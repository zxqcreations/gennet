...
a.add_layer([7, 7, 512, 4096], [4096], 'vgg_16/fc6', padding='VALID')
print(a.net_shape)
a.add_layer([1, 1, 4096, 4096], [4096], 'vgg_16/fc7', padding='VALID')
print(a.net_shape)
a.add_layer([1, 1, 4096, 1000], [1000], 'vgg_16/fc8', padding='VALID')
print(a.net_shape)
a.softmax()
